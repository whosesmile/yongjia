reserveModule.controller('recordController', function ($scope, $state, $modal, growl, recordService, controllerGenerator, $q, dialog, memberService, commonService, goodsService) {
  // 给$scope添加标准化CRUD操作

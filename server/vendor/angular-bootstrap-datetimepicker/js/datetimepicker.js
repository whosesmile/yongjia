...
angular.module('ui.bootstrap.datetimepicker', [])
  ...
  .directive('datetimepicker', ['dateTimePickerConfig', '$filter', '$timeout',
    function (defaultConfig, $filter, $timeout) {
      "use strict";
      ...
      return {
        ...
        link: function (scope, element, attrs, controller) {
          ...
          controller.$render = function () {
            var input = element.parentsUntil('.dropdown').parent().find('input')
            input.val(controller.$isEmpty(controller.$viewValue) ? '' : $filter('date')(controller.$viewValue, 'yyyy-MM-dd HH:mm:ss'));
          };
          ...
          var dataFactory = {
            ...
            setTime: function (unixDate) {
              ...
              if (configuration.dropdownSelector) {
                angular.element(configuration.dropdownSelector).removeClass('open');
              }
              ...
              element.parentsUntil('.dropdown').parent().removeClass('open');
